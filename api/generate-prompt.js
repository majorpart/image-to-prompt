export default async function handler(req, res) {
    ...
    try {
        ...
        if (structuredPrompt === 'yes') {
            instruction = `你是一名专业AI绘画提示词工程师。请严格按以下结构化格式分析图片并生成${promptLanguage} 提示词，无需思考过程，直接输出结果。主体:[描述图片核心对象：人物/动物/物体/场景的具体特征，包括性别、年龄、种族、姿势、动作、表情等]。外观细节:[描述主体的外貌特征、服装款式、发型设计、手持道具、佩戴配饰等具体细节]。环境背景:[说明场景的具体位置与环境特征，如森林深处、未来都市、奇幻空间等；描述光线效果与氛围，如柔光晨雾、霓虹夜景、戏剧性灯光等]。风格质感：[指定艺术风格：写实/赛博朋克/动漫/水彩等；定义色调倾向：冷色调/暖色调/高对比度/单色等]。`;
        } else {
